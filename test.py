...
def EMC(i):
  ...
  sim_time = 10e-12  # simulation time (s)
  ...
  ax.plot(time / T0, v_drift[:, 0] / V0, c='k', label="x-axis drift velocity")
  ax.plot(time / T0, v_drift[:, 1] / V0, c='b', label="y-axis drift velocity")
  plt.legend()
  ...
  ax.set_xlabel(r'Time (ps)')
  ax.set_ylabel(r'Energy Gain (meV)')

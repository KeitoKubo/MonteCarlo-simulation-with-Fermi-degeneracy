...
def EMC(i):
	...
	fig.tight_layout()
	fig.savefig('imgs/EMC_degeneracy/dist_function_F_0/' + "v_drift E_mean time response F_" + str(int(F_x * 1e-5)) + "e5" + "_new/"+ "EF_" + str(int(E_F * 1e3)) + "meV" + "_" + str(int(sim_time_index)))
